...
vec3 loc[] = {
    vec3(0.0f,0,-2.0f), //blue recycle
    vec3(0.4f,0.0f,-3.5f), //black other
    vec3(1.0f,0.0f,-2.0f), //red harmful
    vec3(1.4f,0.0f,-3.5f), //green kitchen
    vec3(2.0f,0.0f,-2.0f), //red harmful
    vec3(2.4f,0.0f,-3.5f),
    vec3(3.0f,0.0f,-2.0f), //red harmful
    vec3(3.4f,0.0f,-3.5f)
};
...
unsigned int loadTextureNearLinear(char const * path)
{
...
unsigned int loadTextureNear(char const * path)
{
    unsigned int textureID;
    glGenTextures(1, &textureID);
...
//    stbi_set_flip_vertically_on_load(true);
    ...
    Shader* skyShader = new Shader("/Users/buxin/Documents/real-time-rendering/rendering/Lab4/skyBoxVertex.vert","/Users/buxin/Documents/real-time-rendering/rendering/Lab4/skyBoxFragment.frag");
//    Shader* normalMapShader = new Shader("/Users/buxin/Documents/real-time-rendering/rendering/Lab3/vertexSource.vert","/Users/buxin/Documents/real-time-rendering/rendering/Lab3/fragementSource.frag");
    Shader* normalMapShader = new Shader("/Users/buxin/Documents/real-time-rendering/rendering/Lab4/normalVertex.vert","/Users/buxin/Documents/real-time-rendering/rendering/Lab4/normalFrag.frag");
    unsigned int cubemapTexture = loadCubemap(faces);

    unsigned int diffuseMap = loadTexture("/Users/buxin/Documents/real-time-rendering/rendering/Lab4/BrickSmallBrown.jpg");
    unsigned int diffuseMapNear = loadTextureNear("/Users/buxin/Documents/real-time-rendering/rendering/Lab4/BrickSmallBrown.jpg");
    unsigned int diffuseMapNearLinear = loadTextureNearLinear("/Users/buxin/Documents/real-time-rendering/rendering/Lab4/BrickSmallBrown.jpg");
    unsigned int diffuseMapMip = loadTextureMip("/Users/buxin/Documents/real-time-rendering/rendering/Lab4/BrickSmallBrown.jpg");
...
//    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void*)(3 * sizeof(float)));
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        for(int i = 0; i < 2; i++){
            modelMat = translate(mat4(1.0f), loc[i]);
            modelMat = glm::rotate(modelMat, glm::radians(75.0f), glm::normalize(glm::vec3(0.0, 1.0, 0.0)));
    ...
    //        myMaterial->shader->SetUniform1f("material.shininess", myMaterial->shininess);
            ...
            glUniform3f(glGetUniformLocation(normalMapShader->ID,"lightPos"),-1.5f,0.0f, -2.0f);
    ...
    //        modelMat = scale(modelMat, vec3(1,1,0.2));
            ...
            glBindVertexArray(quadVAO);
            glActiveTexture(GL_TEXTURE0);
            glBindTexture(GL_TEXTURE_2D, diffuseMapNear);
            glDrawArrays(GL_TRIANGLES, 0, 36);
            glBindVertexArray(0);
    ...
    //        modelMat = scale(modelMat, vec3(1,1,0.2));
            ...
            glBindVertexArray(quadVAO);
            glActiveTexture(GL_TEXTURE0);
            glBindTexture(GL_TEXTURE_2D, diffuseMapNearLinear);
            glDrawArrays(GL_TRIANGLES, 0, 36);
            glBindVertexArray(0);
    ...
    //        modelMat = scale(modelMat, vec3(1,1,0.2));
            ...
            glBindVertexArray(quadVAO);
            glActiveTexture(GL_TEXTURE0);
            glBindTexture(GL_TEXTURE_2D, diffuseMapMip);
            glDrawArrays(GL_TRIANGLES, 0, 36);
            glBindVertexArray(0);
